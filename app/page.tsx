...
export default function Home(){
 ...
 return <main className="app-shell">
  ...
  {tab==="home"&&<div className="screen home-screen">
   <section className={`cover ${gallery[0]?"has-photo":"default-cover"}`} style={gallery[0]?{backgroundImage:`linear-gradient(180deg,transparent 40%,rgba(0,0,0,.45)),url(${gallery[0]})`}:{backgroundImage:"linear-gradient(180deg,transparent 45%,rgba(0,0,0,.5)),url(/og.jpg)"}}/>
