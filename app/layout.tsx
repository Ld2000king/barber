...
import "./globals.css";
export const metadata:Metadata={title:"Barber App",description:"אפליקציית PWA למספרה — מחירון, גלריה, מוצרים ודרכי הגעה.",applicationName:"Barber App",manifest:"/manifest.webmanifest",appleWebApp:{capable:true,statusBarStyle:"black-translucent",title:"Barber App"},icons:{icon:"/icon.svg",apple:"/icon.svg"},openGraph:{title:"BARBERA",description:"הסטייל שלך. בדיוק שלך.",images:["/og.jpg"]},twitter:{card:"summary_large_image",title:"BARBERA",description:"הסטייל שלך. בדיוק שלך.",images:["/og.jpg"]}};
